<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="petDetails.aspx.cs" Inherits="New_Pet_System.petDetails" %>
...
<div class="container">
    <ul class="nav nav-tabs">
      <li class="nav-item">
        <a class="nav-link active" aria-current="page" href="#">Pet Details</a>
      </li>
      <li class="nav-item">
