    ...
    <div class="class-sign-up">
        <div id="id-box-container">
            ...
            <form id="form" runat="server">
                ...
                <br />
                <div id="id-checkbox">
                <asp:CheckBox runat="server" type="checkbox" id="Agree" required="required" OnCheckedChanged="Agree_CheckedChanged"/><label style="font-size: 15px;" for="agree"> I accept to the <a href="google.com"> terms and conditions </a>  of use.</label><br/>
                <br/><br/>
                   </div>
